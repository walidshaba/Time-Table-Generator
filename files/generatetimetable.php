...
<body style="margin-bottom: 20px;">
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse move-me">
                <ul class="nav navbar-nav navbar-left">
                    <li><a href="addteachers.php">ADD LECTURER</a></li>
                    <li><a href="addsubjects.php">ADD COURSE</a></li>
                    <li><a href="addclassrooms.php">ADD VENUE</a></li>
                        ...
                        if (isset($_POST['select_semester'])) {
                            while ($r = mysqli_fetch_assoc($qq)) {
                                if ($r['isAlloted'] == 1 && $r['semester'] == $_POST['select_semester']) {
                                    $str .= $r['subject_name'] . ": " . $r['subject_code'] . ", ";
    ...
    <script>
        ...
        //     doc.html(document.getElementById('TT'), function() {
        //         doc.save('<?php
                                //                     if (isset($_POST["select_semester"])) {
